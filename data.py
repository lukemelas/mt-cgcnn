...
class CIFData(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # This line is modified, as we have 2 targets (due to MT_CGCNN)
        prop_data = self.id_prop_data[idx]
        if len(prop_data) == 3:
           cif_id, target, target2 = prop_data
        elif len(prop_data) == 2:
           cif_id, target = prop_data
        else:
            ValueError('properties data should have 2 or 3 columns')
